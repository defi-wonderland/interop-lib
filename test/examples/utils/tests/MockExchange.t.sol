...
contract MockExchangeTest is Test {
    ...
    function test_Swap_UnsupportedPair() public {
        ...
        vm.expectRevert(abi.encodeWithSelector(MockExchange.UnsupportedPair.selector, address(tokenB), address(tokenA)));
    ...
    function test_Swap_InsufficientBalance() public {
        ...
        vm.expectRevert(
            abi.encodeWithSelector(MockExchange.InsufficientBalance.selector, address(tokenA), 2000 ether, 1000 ether)
        );
    ...
    function test_Swap_InsufficientLiquidity() public {
        ...
        vm.expectRevert(abi.encodeWithSignature("SwapFailedError(string)", "Insufficient exchange liquidity"));
    ...
    function test_SetFailureMode() public {
        ...
        vm.expectRevert(abi.encodeWithSignature("SwapFailedError(string)", "Forced failure for testing"));
